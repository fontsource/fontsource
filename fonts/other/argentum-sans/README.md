...
```javascript
yarn add @fontsource/argentum-sans // npm install @fontsource/argentum-sans
```
...
Font [Source](https://github.com/cssobral2013/Argentum-Sans) and [License](https://github.com/cssobral2013/Argentum-Sans/blob/master/OFL.txt).
