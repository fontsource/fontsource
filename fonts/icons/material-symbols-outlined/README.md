...
```javascript
yarn add @fontsource/material-symbols-outlined // npm install @fontsource/material-symbols-outlined
```
...
Font [Source](https://fonts.google.com/icons) and [License](https://www.apache.org/licenses/LICENSE-2.0).
