			...
			<Group>
				{metadata.subsets.map((subset) => (
					<Badge
						...
						onClick={() => {
							handleActiveSubset(subset);
						}}
						data-active={isActive.subsets.includes(subset)}
					>
						{subset}
					</Badge>
				))}
			...
			<Group>
				{Object.keys(variable.axes).map((axis) => (
					<Badge
						...
						className={classes.badge}
						onClick={() => {
							handleActiveVariant(axis);
						}}
						data-active={Boolean(isActive.axes[axis])}
					>
						{axis}
					</Badge>
				))}
			...
			<Group>
				{DISPLAYS.map((display) => (
					<Badge
						...
						className={classes.badge}
						onClick={() => {
							handleActiveDisplay(display);
						}}
						data-active={isActive.display === display}
					>
						{display}
					</Badge>
				))}
			...
			<Group>
				{metadata.subsets.map((subset) => (
					<Badge
						...
						data-active={subsets.includes(subset)}
					>
						{subset}
					</Badge>
				))}
			...
			<Group>
				{DISPLAYS.map((display) => (
					<Badge
						...
						data-active={displayCurrent === display}
					>
						{display}
					</Badge>
				))}
			...
			<Group>
				{FORMATS.map((format) => (
					<Badge
						...
						data-active={formats.includes(format)}
					>
						{format}
					</Badge>
				))}
