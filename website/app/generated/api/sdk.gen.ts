...
/**
 * Get a registry family symbol catalog
 */
...
/**
 * Get complete registry language membership
 */
export const getRegistryLanguageMembership = <ThrowOnError extends boolean = true>(options?: Options<never, ThrowOnError>): RequestResult<GetRegistryLanguageMembershipResponses, GetRegistryLanguageMembershipErrors, ThrowOnError, 'data'> => (options?.client ?? client).get<GetRegistryLanguageMembershipResponses, GetRegistryLanguageMembershipErrors, ThrowOnError, 'data'>({
    responseStyle: 'data',
...
/**
 * Get a full-coverage WOFF2 source font preview
 */
export const getRegistrySourcePreview = <ThrowOnError extends boolean = true>(parameters: {
    sha256: string;
    file: string;
}, options?: Options<never, ThrowOnError>): RequestResult<GetRegistrySourcePreviewResponses, GetRegistrySourcePreviewErrors, ThrowOnError, 'data'> => {
    const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'sha256' }, { in: 'path', key: 'file' }] }]);
    return (options?.client ?? client).get<GetRegistrySourcePreviewResponses, GetRegistrySourcePreviewErrors, ThrowOnError, 'data'>({
        responseStyle: 'data',
...
/**
 * Get archived source font capabilities
 */
