---
title: Stats
description: Retrieve npm download and jsDelivr usage statistics for a Fontsource font.
---
...
Shields-compatible badges are available for totals across all active font packages:

- `GET https://api.fontsource.org/v1/stats/badge/npm-monthly`
- `GET https://api.fontsource.org/v1/stats/badge/npm-total`
- `GET https://api.fontsource.org/v1/stats/badge/jsdelivr-monthly`
- `GET https://api.fontsource.org/v1/stats/badge/jsdelivr-total`
