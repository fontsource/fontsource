...
description: Install, import, and configure variable font packages from Fontsource.
---
...
```jsx
// Supports weights 200-1000 with one variable face per subset.
import "@fontsource-variable/nunito-sans";
```

This imports the default variable face, usually the normal style across the full weight range. The CSS also uses `unicode-range`, so browsers fetch only the character sets used on the page. If you want an italic style or a different set of axes, import the corresponding CSS file instead:
