---
title: Font Display
description: Configure the CSS font-display behavior used by Fontsource fonts.
---
...
To customise the `font-display` property for a specific font, open **Custom CSS** under **[Get font](https://fontsource.org/fonts/open-sans/use?tab=web&setup=custom)** to generate `@font-face` rules with your preferred value.
