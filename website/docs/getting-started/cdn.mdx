...
To use the Fontsource CDN, open **Developer setup** on a font's **Get font** page and choose **CDN**. For example, [Roboto Flex](/fonts/roboto-flex/use?tab=web&method=cdn) generates the relevant URLs and CSS for your project.
