Playwrite Hrvatska Guides is a single-weight font companion that harmonizes seamlessly with the main family, [Playwrite Hrvatska](https://fonts.google.com/specimen/Playwrite+HR). It includes guidelines on the baseline, x-height, ascenders, and descenders. These guides provide a visual aid for primary school children that helps young learners grasp the proportions of letterforms and assists them in drawing letters with confidence and accuracy.
...
![](Playwrite-Hrvatska-Guides_1.png)

#### Playwrite Hrvatska Guides characteristics
...
Find the detailed characteristics of this country's Model in [Playwrite Hrvatska.](https://fonts.google.com/specimen/Playwrite+HR/about#playwrite-hrvatska-characteristics)

![](Playwrite-Hrvatska-Guides_3.png)

#### Family name in font menus

Playwrite Hrvatska Guides appears in font menus with a two-letter country code ‘HR’, **Playwrite HR Guides**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-Hrvatska-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in Hrvatska, see [primarium.info/countries/croatia](https://primarium.info/countries/croatia/).
...
**Google Docs and Slides:** From the font selector drop-down, go to "More Fonts" and search for the desired font name, in this case, "Playwrite HR Guides", and click OK. If some text is already selected, the font choice will apply.
