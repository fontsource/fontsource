Playwrite México Guides is a single-weight font companion that harmonizes seamlessly with the main family, [Playwrite México](https://fonts.google.com/specimen/Playwrite+MX). It includes guidelines on the baseline, x-height, ascenders, and descenders. These guides provide a visual aid for primary school children that helps young learners grasp the proportions of letterforms and assists them in drawing letters with confidence and accuracy.
...
![](Playwrite-Mexico-Guides_1.png)

#### Playwrite México Guides characteristics
...
Find the detailed characteristics of this country's Model in [Playwrite México.](https://fonts.google.com/specimen/Playwrite+MX/about#playwrite-m-xico-characteristics)

![](Playwrite-Mexico-Guides_3.png)

#### Family name in font menus

Playwrite México Guides appears in font menus with a two-letter country code ‘MX’, **Playwrite MX Guides**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-Mexico-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in Mexico, see [primarium.info/countries/mexico](https://primarium.info/countries/mexico/).
...
**Google Docs and Slides:** From the font selector drop-down, go to "More Fonts" and search for the desired font name, in this case, "Playwrite MX Guides", and click OK. If some text is already selected, the font choice will apply.
