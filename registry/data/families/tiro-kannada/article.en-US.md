...
Two type designers separated by an eight-hour time difference, an ocean, and pandemic travel bans collaborated over video calls and email to make a cohesive set of [fonts](https://fonts.google.com/knowledge/glossary/font) in 8 South Asian languages. In 2012, Harvard University Press commissioned Fiona Ross and John Hudson, through [Tiro Typeworks](https://www.tiro.com/contact.html), to design typefaces for the [Murty Classical Library of India](https://www.murtylibrary.com/) book series. The publisher needed to reprint ancient Indian literary, historical, and religious texts, including Vedic and early Sanskrit works. Since these old texts had been printed using traditional [letterforms](https://fonts.google.com/knowledge/glossary/letterform) and early Indian [typography](https://fonts.google.com/knowledge/glossary/typography) techniques, the new fonts needed to retain some of the traditional style of the old texts, yet be clear and legible in modern print and digital media.
