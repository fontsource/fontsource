Playwrite Netherland Guides is a single-weight font companion that harmonizes seamlessly with the main family, [Playwrite Netherland](https://fonts.google.com/specimen/Playwrite+NL). It includes guidelines on the baseline, x-height, ascenders, and descenders. These guides provide a visual aid for primary school children that helps young learners grasp the proportions of letterforms and assists them in drawing letters with confidence and accuracy.

In The Netherlands, handwriting education commonly begins in _Groep_ 3 after students have learned fine and gross motor skills in previous years. The most widely used handwriting model in classrooms is _verbonden schrift_, a slanted continuous cursive with loops. However, teachers have increasingly opted for _blokschrift_, which features unjoined, simplified print letters. Some teachers choose to instruct in both models: one after another, together, or in a permutation that suits their students.

To contribute, see [github.com/TypeTogether/Playwrite](https://github.com/TypeTogether/Playwrite/).

* * *

![](Playwrite-Netherland-Guides_1.png)

#### Playwrite Netherland Guides characteristics
...
Find the detailed characteristics of this country's Model in [Playwrite Netherland.](https://fonts.google.com/specimen/Playwrite+NL/about?query=Neth#playwrite-netherland-characteristics)

![](Playwrite-Netherland-Guides_3.png)

#### Family name in font menus

Playwrite Netherland Guides appears in font menus with a two-letter country code ‘NL’, **Playwrite NL Guides**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-Netherland-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in Netherland, see [primarium.info/countries/the-netherlands](https://primarium.info/countries/the-netherlands/).
...
**Google Docs and Slides:** From the font selector drop-down, go to "More Fonts" and search for the desired font name, in this case, "Playwrite NL Guides", and click OK. If some text is already selected, the font choice will apply.
