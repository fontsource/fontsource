Playwrite Tanzania Guides is a single-weight font companion that harmonizes seamlessly with the main family, [Playwrite Tanzania](https://fonts.google.com/specimen/Playwrite+TZ). It includes guidelines on the baseline, x-height, ascenders, and descenders. These guides provide a visual aid for primary school children that helps young learners grasp the proportions of letterforms and assists them in drawing letters with confidence and accuracy.
...
![](Playwrite-Tanzania-Guides_1.png)

#### Playwrite Tanzania Guides characteristics
...
Find the detailed characteristics of this country's Model in [Playwrite Tanzania.](https://fonts.google.com/specimen/Playwrite+TZ/about?query=Tanza#playwrite-tanzania-characteristics)

![](Playwrite-Tanzania-Guides_3.png)

#### Family name in font menus

Playwrite Tanzania Guides appears in font menus with a two-letter country code ‘TZ’, **Playwrite TZ Guides**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-Tanzania-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in Tanzania, see [primarium.info/countries/tanzania](https://primarium.info/countries/tanzania/).
...
**Google Docs and Slides:** From the font selector drop-down, go to "More Fonts" and search for the desired font name, in this case, "Playwrite TZ Guides", and click OK. If some text is already selected, the font choice will apply.
