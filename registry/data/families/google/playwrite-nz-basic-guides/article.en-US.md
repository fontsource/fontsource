Playwrite New Zealand Basic Guides is a single-weight font designed to harmonize seamlessly with its companion, [Playwrite New Zealand Basic](https://fonts.google.com/specimen/Playwrite+NZ+Basic). This font includes guideline markers on the baseline, x-height, ascenders, and descenders, providing a visual aid for primary school children. These guides help young learners grasp the proportions of letterforms and assist them in drawing letters with confidence and accuracy.

The style of handwriting currently taught in New Zealand is specified in _Teaching Handwriting_, a Ministry of Education publication, which was originally developed in response to teachers’ requests for guidance on the style of handwriting that should be taught in primary school. Teachers and schools usually create their own resources for handwriting instruction based on the style advocated in this document. It was first released in 1985 and its latest iteration was released in 2025. _Teaching Handwriting_ outlines a progressive handwriting education system that advances from simplified print script to semi-joined cursive writing.

Playwrite New Zealand Basic was created in 2025 upon requirements and specifications from the Ministry of Education of New Zealand. It is a variable font with a weight range from Thin (100) to Regular (400), and supports over 150 Latin-based languages.

To contribute, see [github.com/TypeTogether/Playwrite](https://github.com/TypeTogether/Playwrite/).

* * *

![](Playwrite-NZ-Basic-Guides_1.png)

#### Playwrite New Zealand Basic Guides characteristics
...
Find the detailed characteristics of this country's Model in [Playwrite New Zealand Basic.](https://fonts.google.com/specimen/Playwrite+NZ+Basic/about#playwrite-new-zealand-basic-characteristics)

![](Playwrite-NZ-Basic-Guides_3.png)

#### Family name in font menus

Playwrite New Zealand Basic appears in font menus with a two-letter country code ‘NZ’, **Playwrite NZ Basic Guides**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-NZ-Basic-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in New-Zealand, see [primarium.info/countries/new-zealand](https://primarium.info/countries/new-zealand-basic/).
...
**Google Docs and Slides:** From the font selector drop-down, go to "More Fonts" and search for the desired font name, in this case, "Playwrite NZ Basic Guides", and click OK. If some text is already selected, the font choice will apply.
