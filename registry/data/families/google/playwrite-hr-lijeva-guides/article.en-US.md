...
Find the detailed characteristics of this country's Model in [Playwrite Playwrite Hrvatska Lijeva.](https://fonts.google.com/specimen/Playwrite+HR+Lijeva/about#playwrite-hrvatska-lijeva-characteristics)

![](Playwrite-Hrvatska-Lijeva-Guides_3.png)

#### Family name in font menus

Playwrite Hrvatska Lijeva appears in font menus with a two-letter country code ‘HR’ and the word ’Lijeva’, **Playwrite HR Lijeva Guides**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-Hrvatska-Lijeva-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in Hrvatska-Lijeva, see [primarium.info/countries/croatia](https://primarium.info/countries/croatia/).
...
**Google Docs and Slides:** From the font selector drop-down, go to "More Fonts" and search for the desired font name, in this case, "Playwrite HR Lijeva Guides", and click OK. If some text is already selected, the font choice will apply.
