Playwrite India Guides is a single-weight font companion that harmonizes seamlessly with the main family, [Playwrite India](https://fonts.google.com/specimen/Playwrite+IN). It includes guidelines on the baseline, x-height, ascenders, and descenders. These guides provide a visual aid for primary school children that helps young learners grasp the proportions of letterforms and assists them in drawing letters with confidence and accuracy.
...
Find the detailed characteristics of this country's Model in [Playwrite India.](https://fonts.google.com/specimen/Playwrite+IN/about#playwrite-india-characteristics)

![](Playwrite-India-Guides_3.png)

#### Family name in font menus

Playwrite India Guides appears in font menus with a two-letter country code ‘IN’, **Playwrite IN Guides**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-India-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in India, see [primarium.info/countries/india](https://primarium.info/countries/india/).
