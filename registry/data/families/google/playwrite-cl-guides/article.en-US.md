Playwrite Chile Guides is a single-weight font companion that harmonizes seamlessly with the main family, [Playwrite Chile](https://fonts.google.com/specimen/Playwrite+CL). It includes guidelines on the baseline, x-height, ascenders, and descenders. These guides provide a visual aid for primary school children that helps young learners grasp the proportions of letterforms and assists them in drawing letters with confidence and accuracy.

The most prevalent style of handwriting taught in Chile is known as _‘letra ligada’_, or joined letters. This form of cursive handwriting is introduced to children as early as 6 years old, either alongside print letters or as a standalone style. It can be seen as a slantless variant of [English roundhand](https://fonts.google.com/specimen/Playwrite+GB+J), a calligraphic style that emerged in England, gaining widespread popularity in the 18th century, but Chilean type designers note that, while there are structural similarities between the two styles, there are also notable differences. For instance, _letra ligada_ typically features shorter ascenders and descenders, and its uppercase letters are less ornate. This divergence is present in both contemporary typographic and calligraphic examples.

To contribute, see [github.com/TypeTogether/Playwrite](https://github.com/TypeTogether/Playwrite/).

* * *

![](Playwrite-Chile-Guides_1.png)

#### Playwrite Chile Guides characteristics
...
Find the detailed characteristics of this country's Model in [Playwrite Chile.](https://fonts.google.com/specimen/Playwrite+CL/about#playwrite-chile-characteristics)

![](Playwrite-Chile-Guides_3.png)

#### Family name in font menus

Playwrite Chile Guides appears in font menus with a two-letter country code ‘CL’, **Playwrite CL**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-Chile-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in Chile, see [primarium.info/countries/Chile](https://primarium.info/countries/Chile/).
...
**Google Docs and Slides:** From the font selector drop-down, go to "More Fonts" and search for the desired font name, in this case, "Playwrite CL", and click OK. If some text is already selected, the font choice will apply.
