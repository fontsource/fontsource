...
Find the detailed characteristics of this country's Model in [Playwrite België Vlaanderen.](https://fonts.google.com/specimen/Playwrite+BE+VLG/about?query=VLG#playwrite-belgi-vlaams-gewest-characteristics)

![](Playwrite-Belgie-Vlaanderen-Guides_3.png)

#### Family name in font menus

Playwrite België Vlaanderen Guides appears in font menus with a two-letter country code ‘BE’ and a the ‘VLG’ abbreviation **Playwrite BE VLG Guides**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-Belgie-Vlaanderen-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in australia, see [primarium.info/countries/belgium](https://primarium.info/countries/belgium/).
...
**Google Docs and Slides:** From the font selector drop-down, go to "More Fonts" and search for the desired font name, in this case, "Playwrite BE VLG Guides", and click OK. If some text is already selected, the font choice will apply.
