...
[Kumar One Outline](https://fonts.google.com/specimen/Kumar+One+Outline) is a vertical-contrast design, in which both the downstrokes as well as the left and right-hand sides of each letterform are built up out of two parallel lines and the whites space in-between them. The upstrokes and typeface’s horizontals are just thin, single lines.
...
The Kumar project is led by Indian Type Foundry, a type design foundry based in Ahmedabad, India. To contribute, see [github.com/itfoundry/kumar](https://github.com/itfoundry/kumar)
