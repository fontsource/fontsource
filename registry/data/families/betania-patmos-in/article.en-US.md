...
Betania Patmos In is the version of [Betania Patmos](https://fonts.google.com/specimen/Betania+Patmos) with some alternatives (the round letters a, c, d, g, q have an entry stroke at the init or when isolated).

To contribute, see [github.com/huertatipografica/betania-patmos](https://github.com/huertatipografica/betania-patmos).
