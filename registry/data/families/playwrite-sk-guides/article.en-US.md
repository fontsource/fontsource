Playwrite Slovensko Guides is a single-weight font companion that harmonizes seamlessly with the main family, [Playwrite Slovensko](https://fonts.google.com/specimen/Playwrite+SK). It includes guidelines on the baseline, x-height, ascenders, and descenders. These guides provide a visual aid for primary school children that helps young learners grasp the proportions of letterforms and assists them in drawing letters with confidence and accuracy.
...
![](Playwrite-Slovensko-Guides_1.png)

#### Playwrite Slovensko Guides characteristics
...
Find the detailed characteristics of this country's Model in [Playwrite Slovensko.](https://fonts.google.com/specimen/Playwrite+SK/about#playwrite-slovensko-characteristics)

![](Playwrite-Slovensko-Guides_3.png)

#### Family name in font menus

Playwrite Slovensko Guides appears in font menus with a two-letter country code ‘SK’, **Playwrite SK Guides**, and features a single Regular weight.  
The download .zip file includes the static font for this guided version.

![](Playwrite-Slovensko-Guides_2.png)
...
For more information about the Primarium project, visit [primarium.info](https://primarium.info/) and to learn more about handwriting education in Slovakia, see [primarium.info/countries/slovakia](https://primarium.info/countries/slovakia/).
...
**Google Docs and Slides:** From the font selector drop-down, go to "More Fonts" and search for the desired font name, in this case, "Playwrite SK Guides", and click OK. If some text is already selected, the font choice will apply.
