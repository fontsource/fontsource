/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 605579bc09a1ee5981b3c060aa673a48)
// Runtime types generated with workerd@1.20260708.1 2026-05-10 nodejs_compat
interface __BaseEnv_Env {
	METADATA: KVNamespace;
	FONTS: R2Bucket;
	FONTS_BUCKET_NAME: "fonts-preview" | "fonts";
	ARTIFACT_BUILDER: DurableObjectNamespace<import("./worker/src/index").ArtifactBuilder>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/src/index");
		durableNamespaces: "ArtifactBuilder";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FONTS_BUCKET_NAME">> {}
}
