...
```javascript
import "@fontsource/manjari/500.css" // Weight 500.
import "@fontsource/manjari/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/manjari/index.css"; // Weight 400.
...
```scss
@use "@fontsource/manjari/scss/mixins" as Manjari;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include Manjari.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/manjari/files"
);

// Fully customisable single @font-face mixin.
@include Manjari.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/manjari/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/manjari/scss/mixins.scss).
...
```javascript
import "@fontsource/manjari/latin-ext.css" // All weights with normal style included.
import "@fontsource/manjari/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/manjari/greek-900-italic.css" // Italic variant.
```

- Supported subsets: `[latin,latin-ext,malayalam]`
