...
```javascript
import "@fontsource/roboto-slab/500.css" // Weight 500.
import "@fontsource/roboto-slab/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/roboto-slab/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/roboto-slab/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/roboto-slab/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/roboto-slab/files/roboto-slab-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/roboto-slab/scss/mixins.scss).
...
```js
import "@fontsource/roboto-slab/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/roboto-slab/variable-italic.css" // Italic variant.
// Or
import "@fontsource/roboto-slab/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/roboto-slab/latin-ext.css" // All weights with normal style included.
import "@fontsource/roboto-slab/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/roboto-slab/greek-900-italic.css" // Italic variant.
```
