...
```scss
@use "@fontsource/reem-kufi/scss/mixins" as ReemKufi;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include ReemKufi.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/reem-kufi/files"
);

// Fully customisable single @font-face mixin.
@include ReemKufi.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/reem-kufi/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/reem-kufi/scss/mixins.scss).
...
import "@fontsource/reem-kufi/greek-900-italic.css" // Italic variant.
```
