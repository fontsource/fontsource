...
```scss
@import "~@fontsource/annie-use-your-telescope/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/annie-use-your-telescope/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/annie-use-your-telescope/files/annie-use-your-telescope-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/annie-use-your-telescope/scss/mixins.scss).
...
import "@fontsource/annie-use-your-telescope/greek-900-italic.css" // Italic variant.
```
