...
The CSS and web font files to easily self-host the “Brygada 1918” font. Please visit the main [Fontsource monorepo](https://github.com/fontsource/fontsource) to view more details on this package.
...
```javascript
import "@fontsource/brygada-1918/500.css" // Weight 500.
import "@fontsource/brygada-1918/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/brygada-1918/index.css"; // Weight 400.
@import "~@fontsource/brygada-1918/300-italic.css";
```
...
```js
import "@fontsource/brygada-1918/400.css" // Weight 400.
```

Select either a stripped down weights only variant of the font or a full feature variant that contains all the variable axes.

```js
import "@fontsource/brygada-1918/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/brygada-1918/variable-italic.css" // Italic variant.
// Or
import "@fontsource/brygada-1918/variable-full.css" // This contains ALL variable axes. Font files are larger.
import "@fontsource/brygada-1918/variable-full-italic.css" // Italic variant.
```
...
@supports (font-variation-settings: normal) {
  h1 {
    font-family: Brygada 1918variable;
...
```javascript
import "@fontsource/brygada-1918/latin-ext.css" // All weights with normal style included.
import "@fontsource/brygada-1918/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/brygada-1918/greek-900-italic.css" // Italic variant.
```
