...
```scss
@use "@fontsource/andika-new-basic/scss/mixins" as AndikaNew Basic;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include AndikaNew Basic.fontFace($weight: 500, $display: fallback, $fontDir:
      "~@fontsource/andika-new-basic/files");

// Fully customisable single @font-face mixin.
@include AndikaNew Basic.fontFaceCustom($weight: 600, $display: optional, $woff2Path:
...
```scss
@import "~@fontsource/andika-new-basic/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/andika-new-basic/files"
);
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/andika-new-basic/scss/mixins.scss).
...
import "@fontsource/andika-new-basic/greek-900-italic.css" // Italic variant.
```
