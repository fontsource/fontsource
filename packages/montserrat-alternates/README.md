...
```javascript
import "fontsource-montserrat-alternates" // Defaults to weight 400 with all styles included.
```

Fontsource allows you to select weights and even individual styles, allowing you to cut down on payload sizes to the last byte! Utilizing the CSS unicode-range selector, all language subsets are accounted for.

```javascript
import "fontsource-montserrat-alternates/500.css" // All styles included.
import "fontsource-montserrat-alternates/900-normal.css" // Select either normal or italic.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~fontsource-montserrat-alternates/index.css";
...
import "fontsource-montserrat-alternates/cyrillic-ext-500.css" // All styles included.
import "fontsource-montserrat-alternates/greek-900-normal.css" // Select either normal or italic.
```
