...
```javascript
import "@fontsource/mukta-malar/500.css" // Weight 500.
import "@fontsource/mukta-malar/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/mukta-malar/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/mukta-malar/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/mukta-malar/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/mukta-malar/files/mukta-malar-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/mukta-malar/scss/mixins.scss).
...
```javascript
import "@fontsource/mukta-malar/latin-ext.css" // All weights with normal style included.
import "@fontsource/mukta-malar/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/mukta-malar/greek-900-italic.css" // Italic variant.
```
