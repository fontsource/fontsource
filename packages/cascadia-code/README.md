...
```scss
@use "@fontsource/cascadia-code/scss/mixins" as CascadiaCode;

// Fully customisable single @font-face mixin.
@include CascadiaCode.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/cascadia-code/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/cascadia-code/scss/mixins.scss).
...
import "@fontsource/cascadia-code/greek-900-italic.css" // Italic variant.
```
