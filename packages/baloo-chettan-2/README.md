...
```scss
@use "@fontsource/baloo-chettan-2/scss/mixins" as BalooChettan 2;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include BalooChettan 2fontface
  (
    $weight: 500,
    $display: fallback,
    $fontDir: "~@fontsource/baloo-chettan-2/files"
  );

// Fully customisable single @font-face mixin.
@include BalooChettan 2fontfacecustom
  (
    $weight: 600,
    $display: optional,
...
```scss
@import "~@fontsource/baloo-chettan-2/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/baloo-chettan-2/scss/mixins.scss).
...
import "@fontsource/baloo-chettan-2/greek-900-italic.css" // Italic variant.
```
