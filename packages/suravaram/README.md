...
```scss
@use "@fontsource/suravaram/scss/mixins" as Suravaram;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include Suravaram.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/suravaram/files"
);

// Fully customisable single @font-face mixin.
@include Suravaram.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/suravaram/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/suravaram/scss/mixins.scss).
...
import "@fontsource/suravaram/greek-900-italic.css" // Italic variant.
```
