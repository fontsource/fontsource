...
```javascript
import "@fontsource/amiri/500.css" // Weight 500.
import "@fontsource/amiri/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/amiri/index.css"; // Weight 400.
...
```scss
@use "@fontsource/amiri/scss/mixins" as Amiri;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include Amiri.fontFace(
  $weight: 500,
  $display: fallback,
