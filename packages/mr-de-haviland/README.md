...
```scss
@import "~@fontsource/mr-de-haviland/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/mr-de-haviland/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/mr-de-haviland/files/mr-de-haviland-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/mr-de-haviland/scss/mixins.scss).
...
import "@fontsource/mr-de-haviland/greek-900-italic.css" // Italic variant.
```
