...
```javascript
import "@fontsource/bitter/500.css" // Weight 500.
import "@fontsource/bitter/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/bitter/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/bitter/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/bitter/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/bitter/files/bitter-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/bitter/scss/mixins.scss).
...
```js
import "@fontsource/bitter/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/bitter/variable-italic.css" // Italic variant.
// Or
import "@fontsource/bitter/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/bitter/latin-ext.css" // All weights with normal style included.
import "@fontsource/bitter/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/bitter/greek-900-italic.css" // Italic variant.
```
