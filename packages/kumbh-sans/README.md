...
```scss
@use "@fontsource/kumbh-sans/scss/mixins" as KumbhSans;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include KumbhSans.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/kumbh-sans/files"
);

// Fully customisable single @font-face mixin.
@include KumbhSans.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/kumbh-sans/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/kumbh-sans/scss/mixins.scss).
...
import "@fontsource/kumbh-sans/greek-900-italic.css" // Italic variant.
```
