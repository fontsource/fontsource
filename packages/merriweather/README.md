...
```javascript
import "fontsource-merriweather" //require("fontsource-merriweather")
```
...
import "fontsource-merriweather/cyrillic-ext-400.css" // All styles included.
import "fontsource-merriweather/greek-700-normal.css" // Select either normal or italic.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~fontsource-merriweather/index";
@import "~fontsource-merriweather/vietnamese-300-italic";
```
