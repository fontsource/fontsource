...
```js
import "fontsource-ibarra-real-nova/variable.css" // Contains ONLY variable weights and no other axes. Both normal and italic.
import "fontsource-ibarra-real-nova/variable-normal.css" // Normal variant.
import "fontsource-ibarra-real-nova/variable-italic.css" // Italic variant.
// Or
import "fontsource-ibarra-real-nova/variable-full.css" // This contains ALL variable axes. Font files are larger. Both normal and italic.
import "fontsource-ibarra-real-nova/variable-full-normal.css" // Normal variant.
