...
```javascript
import "@fontsource/cinzel/500.css" // Weight 500.
import "@fontsource/cinzel/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/cinzel/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/cinzel/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/cinzel/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/cinzel/files/cinzel-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/cinzel/scss/mixins.scss).
...
```js
import "@fontsource/cinzel/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/cinzel/variable-italic.css" // Italic variant.
// Or
import "@fontsource/cinzel/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/cinzel/latin-ext.css" // All weights with normal style included.
import "@fontsource/cinzel/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/cinzel/greek-900-italic.css" // Italic variant.
```
