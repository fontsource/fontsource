...
```javascript
import "@fontsource/rosario/500.css" // Weight 500.
import "@fontsource/rosario/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/rosario/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/rosario/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/rosario/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/rosario/files/rosario-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/rosario/scss/mixins.scss).
...
```js
import "@fontsource/rosario/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/rosario/variable-italic.css" // Italic variant.
// Or
import "@fontsource/rosario/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/rosario/latin-ext.css" // All weights with normal style included.
import "@fontsource/rosario/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/rosario/greek-900-italic.css" // Italic variant.
```
