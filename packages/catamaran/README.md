...
```javascript
import "@fontsource/catamaran/500.css" // Weight 500.
import "@fontsource/catamaran/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/catamaran/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/catamaran/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/catamaran/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/catamaran/files/catamaran-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/catamaran/scss/mixins.scss).
...
```js
import "@fontsource/catamaran/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/catamaran/variable-italic.css" // Italic variant.
// Or
import "@fontsource/catamaran/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/catamaran/latin-ext.css" // All weights with normal style included.
import "@fontsource/catamaran/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/catamaran/greek-900-italic.css" // Italic variant.
```
