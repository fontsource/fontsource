...
```javascript
import "@fontsource/playfair-display/500.css" // Weight 500.
import "@fontsource/playfair-display/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/playfair-display/index.css"; // Weight 400.
...
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/playfair-display/files"
);
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/playfair-display/scss/mixins.scss).
...
```js
import "@fontsource/playfair-display/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/playfair-display/variable-italic.css" // Italic variant.
// Or
import "@fontsource/playfair-display/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/playfair-display/latin-ext.css" // All weights with normal style included.
import "@fontsource/playfair-display/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/playfair-display/greek-900-italic.css" // Italic variant.
```
