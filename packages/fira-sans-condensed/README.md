...
```javascript
import "@fontsource/fira-sans-condensed/500.css" // Weight 500.
import "@fontsource/fira-sans-condensed/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/fira-sans-condensed/index.css"; // Weight 400.
...
```scss
@use "@fontsource/fira-sans-condensed/scss/mixins" as FiraSans Condensed;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include FiraSans Condensed.fontFace($weight: 500, $display: fallback, $fontDir:
      "~@fontsource/fira-sans-condensed/files");

// Fully customisable single @font-face mixin.
@include FiraSans Condensed.fontFaceCustom($weight: 600, $display: optional, $woff2Path:
...
```scss
@import "~@fontsource/fira-sans-condensed/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/fira-sans-condensed/files"
);
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/fira-sans-condensed/scss/mixins.scss).
...
```javascript
import "@fontsource/fira-sans-condensed/latin-ext.css" // All weights with normal style included.
import "@fontsource/fira-sans-condensed/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/fira-sans-condensed/greek-900-italic.css" // Italic variant.
```
