...
```javascript
import "@fontsource/arima-madurai/500.css" // Weight 500.
import "@fontsource/arima-madurai/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/arima-madurai/index.css"; // Weight 400.
...
```scss
@use "@fontsource/arima-madurai/scss/mixins" as ArimaMadurai;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include ArimaMadurai.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/arima-madurai/files"
);

// Fully customisable single @font-face mixin.
@include ArimaMadurai.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/arima-madurai/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/arima-madurai/scss/mixins.scss).
...
```javascript
import "@fontsource/arima-madurai/latin-ext.css" // All weights with normal style included.
import "@fontsource/arima-madurai/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/arima-madurai/greek-900-italic.css" // Italic variant.
```
