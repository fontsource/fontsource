...
```javascript
import "@fontsource/cormorant-garamond/500.css" // Weight 500.
import "@fontsource/cormorant-garamond/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/cormorant-garamond/index.css"; // Weight 400.
...
```scss
@use "@fontsource/cormorant-garamond/scss/mixins" as CormorantGaramond;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include CormorantGaramond.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/cormorant-garamond/files"
);

// Fully customisable single @font-face mixin.
@include CormorantGaramond.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/cormorant-garamond/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/cormorant-garamond/scss/mixins.scss).
...
```javascript
import "@fontsource/cormorant-garamond/latin-ext.css" // All weights with normal style included.
import "@fontsource/cormorant-garamond/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/cormorant-garamond/greek-900-italic.css" // Italic variant.
```
