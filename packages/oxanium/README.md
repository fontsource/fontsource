...
```javascript
import "@fontsource/oxanium/500.css" // Weight 500.
import "@fontsource/oxanium/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/oxanium/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/oxanium/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/oxanium/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/oxanium/files/oxanium-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/oxanium/scss/mixins.scss).
...
```js
import "@fontsource/oxanium/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/oxanium/variable-italic.css" // Italic variant.
// Or
import "@fontsource/oxanium/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/oxanium/latin-ext.css" // All weights with normal style included.
import "@fontsource/oxanium/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/oxanium/greek-900-italic.css" // Italic variant.
```
