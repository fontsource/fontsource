...
```javascript
import "@fontsource/manuale/500.css" // Weight 500.
import "@fontsource/manuale/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/manuale/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/manuale/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/manuale/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/manuale/files/manuale-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/manuale/scss/mixins.scss).
...
```js
import "@fontsource/manuale/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/manuale/variable-italic.css" // Italic variant.
// Or
import "@fontsource/manuale/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/manuale/latin-ext.css" // All weights with normal style included.
import "@fontsource/manuale/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/manuale/greek-900-italic.css" // Italic variant.
```
