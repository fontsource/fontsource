...
```javascript
import "@fontsource/tajawal/500.css" // Weight 500.
import "@fontsource/tajawal/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/tajawal/index.css"; // Weight 400.
...
```scss
@use "@fontsource/tajawal/scss/mixins" as Tajawal;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include Tajawal.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/tajawal/files"
);

// Fully customisable single @font-face mixin.
@include Tajawal.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/tajawal/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/tajawal/scss/mixins.scss).
...
```javascript
import "@fontsource/tajawal/latin-ext.css" // All weights with normal style included.
import "@fontsource/tajawal/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/tajawal/greek-900-italic.css" // Italic variant.
```
