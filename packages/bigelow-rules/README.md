...
```javascript
import "@fontsource/bigelow-rules/500.css" // Weight 500.
import "@fontsource/bigelow-rules/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/bigelow-rules/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/bigelow-rules/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/bigelow-rules/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/bigelow-rules/files/bigelow-rules-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/bigelow-rules/scss/mixins.scss).
...
```javascript
import "@fontsource/bigelow-rules/latin-ext.css" // All weights with normal style included.
import "@fontsource/bigelow-rules/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/bigelow-rules/greek-900-italic.css" // Italic variant.
```
