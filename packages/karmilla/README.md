...
```scss
@use "@fontsource/karmilla/scss/mixins" as Karmilla;

// Fully customisable single @font-face mixin.
@include Karmilla.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/karmilla/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/karmilla/scss/mixins.scss).
...
import "@fontsource/karmilla/greek-900-italic.css" // Italic variant.
```
