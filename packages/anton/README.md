...
```javascript
import "fontsource-anton/500.css" // All styles included.
import "fontsource-anton/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-anton/cyrillic-ext-500.css" // All styles included.
import "fontsource-anton/greek-900-normal.css" // Select either normal or italic.
```
