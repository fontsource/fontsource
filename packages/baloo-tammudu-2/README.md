...
```javascript
import "@fontsource/baloo-tammudu-2/500.css" // Weight 500.
import "@fontsource/baloo-tammudu-2/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/baloo-tammudu-2/index.css"; // Weight 400.
...
```scss
@use "@fontsource/baloo-tammudu-2/scss/mixins" as BalooTammudu 2;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include BalooTammudu 2fontface
  (
    $weight: 500,
    $display: fallback,
    $fontDir: "~@fontsource/baloo-tammudu-2/files"
  );

// Fully customisable single @font-face mixin.
@include BalooTammudu 2fontfacecustom
  (
    $weight: 600,
    $display: optional,
...
```scss
@import "~@fontsource/baloo-tammudu-2/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/baloo-tammudu-2/scss/mixins.scss).
...
```javascript
import "@fontsource/baloo-tammudu-2/latin-ext.css" // All weights with normal style included.
import "@fontsource/baloo-tammudu-2/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/baloo-tammudu-2/greek-900-italic.css" // Italic variant.
```
