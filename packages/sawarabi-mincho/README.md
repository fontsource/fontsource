...
```javascript
import "@fontsource/sawarabi-mincho/500.css" // Weight 500.
import "@fontsource/sawarabi-mincho/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/sawarabi-mincho/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/sawarabi-mincho/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/sawarabi-mincho/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/sawarabi-mincho/files/sawarabi-mincho-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/sawarabi-mincho/scss/mixins.scss).
...
```javascript
import "@fontsource/sawarabi-mincho/latin-ext.css" // All weights with normal style included.
import "@fontsource/sawarabi-mincho/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/sawarabi-mincho/greek-900-italic.css" // Italic variant.
```
