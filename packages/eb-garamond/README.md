...
import "@fontsource/eb-garamond/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/eb-garamond/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/eb-garamond/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/eb-garamond/files"
);
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/eb-garamond/scss/mixins.scss).
...
```js
import "@fontsource/eb-garamond/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/eb-garamond/variable-italic.css" // Italic variant.
// Or
import "@fontsource/eb-garamond/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/eb-garamond/latin-ext.css" // All weights with normal style included.
import "@fontsource/eb-garamond/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/eb-garamond/greek-900-italic.css" // Italic variant.
```
