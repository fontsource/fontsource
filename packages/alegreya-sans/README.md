...
```scss
@use "@fontsource/alegreya-sans/scss/mixins" as AlegreyaSans;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include AlegreyaSans.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/alegreya-sans/files"
);

// Fully customisable single @font-face mixin.
@include AlegreyaSans.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/alegreya-sans/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/alegreya-sans/scss/mixins.scss).
...
import "@fontsource/alegreya-sans/greek-900-italic.css" // Italic variant.
```
