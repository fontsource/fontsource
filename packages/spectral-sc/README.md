...
```scss
@use "@fontsource/spectral-sc/scss/mixins" as SpectralSC;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include SpectralSC.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/spectral-sc/files"
);

// Fully customisable single @font-face mixin.
@include SpectralSC.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/spectral-sc/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/spectral-sc/scss/mixins.scss).
...
import "@fontsource/spectral-sc/greek-900-italic.css" // Italic variant.
```
