...
```javascript
import "@fontsource/vollkorn/500.css" // Weight 500.
import "@fontsource/vollkorn/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/vollkorn/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/vollkorn/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/vollkorn/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/vollkorn/files/vollkorn-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/vollkorn/scss/mixins.scss).
...
```js
import "@fontsource/vollkorn/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/vollkorn/variable-italic.css" // Italic variant.
// Or
import "@fontsource/vollkorn/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/vollkorn/latin-ext.css" // All weights with normal style included.
import "@fontsource/vollkorn/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/vollkorn/greek-900-italic.css" // Italic variant.
```
