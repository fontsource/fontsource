...
import "@fontsource/archivo/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/archivo/index.css"; // Weight 400.
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/archivo/files/archivo-latin-500-normal.woff2",
  $unicodeRange: false
);
...
```javascript
import "@fontsource/archivo/latin-ext.css" // All weights with normal style included.
import "@fontsource/archivo/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/archivo/greek-900-italic.css" // Italic variant.
```
