...
```javascript
import "@fontsource/museomoderno/500.css" // Weight 500.
import "@fontsource/museomoderno/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/museomoderno/index.css"; // Weight 400.
...
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/museomoderno/files"
);
...
```js
import "@fontsource/museomoderno/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/museomoderno/variable-italic.css" // Italic variant.
// Or
import "@fontsource/museomoderno/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/museomoderno/latin-ext.css" // All weights with normal style included.
import "@fontsource/museomoderno/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/museomoderno/greek-900-italic.css" // Italic variant.
```
