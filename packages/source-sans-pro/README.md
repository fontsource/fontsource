...
```javascript
import "fontsource-source-sans-pro/500.css" // All styles included.
import "fontsource-source-sans-pro/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-source-sans-pro/cyrillic-ext-500.css" // All styles included.
import "fontsource-source-sans-pro/greek-900-normal.css" // Select either normal or italic.
```
