...
```javascript
import "@fontsource/petrona/500.css" // Weight 500.
import "@fontsource/petrona/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/petrona/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/petrona/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/petrona/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/petrona/files/petrona-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/petrona/scss/mixins.scss).
...
```js
import "@fontsource/petrona/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/petrona/variable-italic.css" // Italic variant.
// Or
import "@fontsource/petrona/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/petrona/latin-ext.css" // All weights with normal style included.
import "@fontsource/petrona/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/petrona/greek-900-italic.css" // Italic variant.
```
