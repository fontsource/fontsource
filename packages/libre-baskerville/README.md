...
```javascript
import "@fontsource/libre-baskerville/500.css" // Weight 500.
import "@fontsource/libre-baskerville/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/libre-baskerville/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/libre-baskerville/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/libre-baskerville/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/libre-baskerville/files/libre-baskerville-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/libre-baskerville/scss/mixins.scss).
...
```javascript
import "@fontsource/libre-baskerville/latin-ext.css" // All weights with normal style included.
import "@fontsource/libre-baskerville/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/libre-baskerville/greek-900-italic.css" // Italic variant.
```
