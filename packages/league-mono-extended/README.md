...
The CSS and web font files to easily self-host the “League Mono Extended” font. Please visit the main [Fontsource monorepo](https://github.com/DecliningLotus/fontsource) to view more details on this package.
...
```javascript
import "fontsource-league-mono-extended" //require("fontsource-league-mono-extended")
```
...
```scss
@import "~fontsource-league-mono-extended/index";
@import "~fontsource-league-mono-extended/vietnamese-300-italic";
```
