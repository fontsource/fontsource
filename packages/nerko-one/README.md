...
```scss
@use "@fontsource/nerko-one/scss/mixins" as NerkoOne;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include NerkoOne.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/nerko-one/files"
);

// Fully customisable single @font-face mixin.
@include NerkoOne.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/nerko-one/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/nerko-one/scss/mixins.scss).
...
import "@fontsource/nerko-one/greek-900-italic.css" // Italic variant.
```
