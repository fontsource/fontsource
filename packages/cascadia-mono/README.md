...
```scss
@use "@fontsource/cascadia-mono/scss/mixins" as CascadiaMono;

// Fully customisable single @font-face mixin.
@include CascadiaMono.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/cascadia-mono/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/cascadia-mono/scss/mixins.scss).
...
import "@fontsource/cascadia-mono/greek-900-italic.css" // Italic variant.
```
