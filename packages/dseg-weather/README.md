...
```scss
@use "@fontsource/dseg-weather/scss/mixins" as DSEGWeather;

// Fully customisable single @font-face mixin.
@include DSEGWeather.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/dseg-weather/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/dseg-weather/scss/mixins.scss).
...
import "@fontsource/dseg-weather/greek-900-italic.css" // Italic variant.
```
