...
```scss
@import "~@fontsource/big-shoulders-display/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/big-shoulders-display/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/big-shoulders-display/files/big-shoulders-display-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/big-shoulders-display/scss/mixins.scss).
...
import "@fontsource/big-shoulders-display/greek-900-italic.css" // Italic variant.
```
