...
```javascript
import "@fontsource/markazi-text/500.css" // Weight 500.
import "@fontsource/markazi-text/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/markazi-text/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/markazi-text/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/markazi-text/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/markazi-text/files/markazi-text-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/markazi-text/scss/mixins.scss).
...
```js
import "@fontsource/markazi-text/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/markazi-text/variable-italic.css" // Italic variant.
// Or
import "@fontsource/markazi-text/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/markazi-text/latin-ext.css" // All weights with normal style included.
import "@fontsource/markazi-text/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/markazi-text/greek-900-italic.css" // Italic variant.
```
