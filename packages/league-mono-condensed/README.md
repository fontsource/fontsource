...
```scss
@use "@fontsource/league-mono-condensed/scss/mixins" as LeagueMono Condensed;

// Fully customisable single @font-face mixin.
@include LeagueMono Condensed.fontFaceCustom($weight: 600, $display: optional, $woff2Path:
