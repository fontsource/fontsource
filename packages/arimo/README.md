...
```javascript
import "@fontsource/arimo/500.css" // Weight 500.
import "@fontsource/arimo/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/arimo/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/arimo/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/arimo/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/arimo/files/arimo-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/arimo/scss/mixins.scss).
...
```js
import "@fontsource/arimo/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/arimo/variable-italic.css" // Italic variant.
// Or
import "@fontsource/arimo/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/arimo/latin-ext.css" // All weights with normal style included.
import "@fontsource/arimo/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/arimo/greek-900-italic.css" // Italic variant.
```
