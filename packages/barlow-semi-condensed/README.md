...
```javascript
import "@fontsource/barlow-semi-condensed/500.css" // Weight 500.
import "@fontsource/barlow-semi-condensed/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/barlow-semi-condensed/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/barlow-semi-condensed/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/barlow-semi-condensed/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/barlow-semi-condensed/files/barlow-semi-condensed-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/barlow-semi-condensed/scss/mixins.scss).
...
```javascript
import "@fontsource/barlow-semi-condensed/latin-ext.css" // All weights with normal style included.
import "@fontsource/barlow-semi-condensed/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/barlow-semi-condensed/greek-900-italic.css" // Italic variant.
```
