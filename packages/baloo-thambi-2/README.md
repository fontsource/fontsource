...
```scss
@use "@fontsource/baloo-thambi-2/scss/mixins" as BalooThambi 2;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include BalooThambi 2fontface
  (
    $weight: 500,
    $display: fallback,
    $fontDir: "~@fontsource/baloo-thambi-2/files"
  );

// Fully customisable single @font-face mixin.
@include BalooThambi 2fontfacecustom
  (
    $weight: 600,
    $display: optional,
...
```scss
@import "~@fontsource/baloo-thambi-2/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/baloo-thambi-2/scss/mixins.scss).
...
import "@fontsource/baloo-thambi-2/greek-900-italic.css" // Italic variant.
```
