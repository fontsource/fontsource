...
```javascript
import "@fontsource/lexend-giga/500.css" // Weight 500.
import "@fontsource/lexend-giga/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/lexend-giga/index.css"; // Weight 400.
...
```scss
@use "@fontsource/lexend-giga/scss/mixins" as LexendGiga;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include LexendGiga.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/lexend-giga/files"
);

// Fully customisable single @font-face mixin.
@include LexendGiga.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/lexend-giga/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/lexend-giga/scss/mixins.scss).
...
```javascript
import "@fontsource/lexend-giga/latin-ext.css" // All weights with normal style included.
import "@fontsource/lexend-giga/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/lexend-giga/greek-900-italic.css" // Italic variant.
```
