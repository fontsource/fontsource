...
```javascript
import "@fontsource/varta/500.css" // Weight 500.
import "@fontsource/varta/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/varta/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/varta/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/varta/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/varta/files/varta-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/varta/scss/mixins.scss).
...
```js
import "@fontsource/varta/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/varta/variable-italic.css" // Italic variant.
// Or
import "@fontsource/varta/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/varta/latin-ext.css" // All weights with normal style included.
import "@fontsource/varta/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/varta/greek-900-italic.css" // Italic variant.
```
