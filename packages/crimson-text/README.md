...
```javascript
import "fontsource-crimson-text/500.css" // All styles included.
import "fontsource-crimson-text/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-crimson-text/cyrillic-ext-500.css" // All styles included.
import "fontsource-crimson-text/greek-900-normal.css" // Select either normal or italic.
```
