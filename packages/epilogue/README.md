...
```javascript
import "@fontsource/epilogue/500.css" // Weight 500.
import "@fontsource/epilogue/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/epilogue/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/epilogue/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/epilogue/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/epilogue/files/epilogue-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/epilogue/scss/mixins.scss).
...
```js
import "@fontsource/epilogue/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/epilogue/variable-italic.css" // Italic variant.
// Or
import "@fontsource/epilogue/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/epilogue/latin-ext.css" // All weights with normal style included.
import "@fontsource/epilogue/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/epilogue/greek-900-italic.css" // Italic variant.
```
