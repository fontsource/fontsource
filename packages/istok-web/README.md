...
```javascript
import "fontsource-istok-web" // Defaults to weight 400 with all styles included.
```

Fontsource allows you to select weights and even individual styles, allowing you to cut down on payload sizes to the last byte! Utilizing the CSS unicode-range selector, all language subsets are accounted for.

```javascript
import "fontsource-istok-web/500.css" // All styles included.
import "fontsource-istok-web/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-istok-web/cyrillic-ext-500.css" // All styles included.
import "fontsource-istok-web/greek-900-normal.css" // Select either normal or italic.
```
