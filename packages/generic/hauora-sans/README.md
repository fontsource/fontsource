...
```javascript
yarn add @fontsource/hauora-sans // npm install @fontsource/hauora-sans
```
...
Font [Source](https://github.com/WCYS-Co/Hauora-Sans) and [License](https://github.com/WCYS-Co/Hauora-Sans/blob/master/OFL.txt).
