...
```scss
@use "@fontsource/cairo/scss/mixins" as Cairo;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include Cairo.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/cairo/files"
);

// Fully customisable single @font-face mixin.
@include Cairo.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/cairo/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/cairo/scss/mixins.scss).
...
import "@fontsource/cairo/greek-900-italic.css" // Italic variant.
```
