...
```javascript
import "fontsource-literata/500.css" // All styles included.
import "fontsource-literata/900-normal.css" // Select either normal or italic.
```
...
```js
import "fontsource-literata/variable.css" // Contains ONLY variable weights and no other axes. Both normal and italic.
import "fontsource-literata/variable-normal.css" // Normal variant.
import "fontsource-literata/variable-italic.css" // Italic variant.
// Or
import "fontsource-literata/variable-full.css" // This contains ALL variable axes. Font files are larger. Both normal and italic.
import "fontsource-literata/variable-full-normal.css" // Normal variant.
...
```javascript
import "fontsource-literata/latin-ext.css" // All weights and styles included.
import "fontsource-literata/cyrillic-ext-500.css" // All styles included.
