...
```javascript
import "@fontsource/yanone-kaffeesatz/500.css" // Weight 500.
import "@fontsource/yanone-kaffeesatz/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/yanone-kaffeesatz/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/yanone-kaffeesatz/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/yanone-kaffeesatz/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/yanone-kaffeesatz/files/yanone-kaffeesatz-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/yanone-kaffeesatz/scss/mixins.scss).
...
```js
import "@fontsource/yanone-kaffeesatz/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/yanone-kaffeesatz/variable-italic.css" // Italic variant.
// Or
import "@fontsource/yanone-kaffeesatz/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/yanone-kaffeesatz/latin-ext.css" // All weights with normal style included.
import "@fontsource/yanone-kaffeesatz/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/yanone-kaffeesatz/greek-900-italic.css" // Italic variant.
```
