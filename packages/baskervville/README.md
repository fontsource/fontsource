...
```scss
@use "@fontsource/baskervville/scss/mixins" as Baskervville;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include Baskervville.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/baskervville/files"
);

// Fully customisable single @font-face mixin.
@include Baskervville.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/baskervville/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/baskervville/scss/mixins.scss).
...
import "@fontsource/baskervville/greek-900-italic.css" // Italic variant.
```
