...
```scss
@use "@fontsource/big-shoulders-inline-text/scss/mixins" as BigShoulders Inline Text;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include BigShoulders Inline Text.fontFace($weight: 500, $display: fallback, $fontDir:
      "~@fontsource/big-shoulders-inline-text/files");

// Fully customisable single @font-face mixin.
@include BigShoulders Inline Text.fontFaceCustom($weight: 600, $display:
