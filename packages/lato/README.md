...
```javascript
import "fontsource-lato/500.css" // All styles included.
import "fontsource-lato/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-lato/cyrillic-ext-500.css" // All styles included.
import "fontsource-lato/greek-900-normal.css" // Select either normal or italic.
```
