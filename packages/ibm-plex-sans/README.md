...
```javascript
import "fontsource-ibm-plex-sans/500.css" // All styles included.
import "fontsource-ibm-plex-sans/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-ibm-plex-sans/cyrillic-ext-500.css" // All styles included.
import "fontsource-ibm-plex-sans/greek-900-normal.css" // Select either normal or italic.
```
