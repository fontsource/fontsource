...
[![npm version](https://badge.fury.io/js/fontsource-vazir.svg)](https://github.com/DecliningLotus/fontsource) [![Generic badge](https://img.shields.io/badge/fontsource-passing-brightgreen)](https://github.com/DecliningLotus/fontsource) [![GitHub stars](https://img.shields.io/github/stars/DecliningLotus/fontsource.svg?style=social&label=Star&maxAge=2592000)](https://GitHub.com/DecliningLotus/fontsource/stargazers/)
...
```javascript
import "fontsource-vazir" //require("fontsource-vazir")
```
...
```scss
@import "~fontsource-vazir/index";
@import "~fontsource-vazir/vietnamese-300-italic";
```
