...
```scss
@use "@fontsource/blackout-midnight/scss/mixins" as BlackoutMidnight;

// Fully customisable single @font-face mixin.
@include BlackoutMidnight.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/blackout-midnight/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/blackout-midnight/scss/mixins.scss).
...
import "@fontsource/blackout-midnight/greek-900-italic.css" // Italic variant.
```
