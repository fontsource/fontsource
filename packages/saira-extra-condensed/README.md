...
```javascript
import "@fontsource/saira-extra-condensed/500.css" // Weight 500.
import "@fontsource/saira-extra-condensed/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/saira-extra-condensed/index.css"; // Weight 400.
...
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/saira-extra-condensed/files"
);
...
```javascript
import "@fontsource/saira-extra-condensed/latin-ext.css" // All weights with normal style included.
import "@fontsource/saira-extra-condensed/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/saira-extra-condensed/greek-900-italic.css" // Italic variant.
```
