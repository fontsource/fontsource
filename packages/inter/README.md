...
```javascript
import "fontsource-inter/500.css" // All styles included.
import "fontsource-inter/900-normal.css" // Select either normal or italic.
```
...
```js
import "fontsource-inter/variable.css" // Contains ONLY variable weights and no other axes. Both normal and italic.
import "fontsource-inter/variable-normal.css" // Normal variant.
import "fontsource-inter/variable-italic.css" // Italic variant.
// Or
import "fontsource-inter/variable-full.css" // This contains ALL variable axes. Font files are larger. Both normal and italic.
import "fontsource-inter/variable-full-normal.css" // Normal variant.
...
```javascript
import "fontsource-inter/latin-ext.css" // All weights and styles included.
import "fontsource-inter/cyrillic-ext-500.css" // All styles included.
import "fontsource-inter/greek-900-normal.css" // Select either normal or italic.
```
