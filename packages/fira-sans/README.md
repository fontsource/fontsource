...
```javascript
import "fontsource-fira-sans" // Defaults to weight 400 with all styles included.
```

Fontsource allows you to select weights and even individual styles, allowing you to cut down on payload sizes to the last byte! Utilizing the CSS unicode-range selector, all language subsets are accounted for.

```javascript
import "fontsource-fira-sans/500.css" // All styles included.
import "fontsource-fira-sans/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-fira-sans/cyrillic-ext-500.css" // All styles included.
import "fontsource-fira-sans/greek-900-normal.css" // Select either normal or italic.
```
