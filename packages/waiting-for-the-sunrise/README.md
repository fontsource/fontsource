...
```javascript
import "fontsource-waiting-for-the-sunrise" // Defaults to weight 400 with all styles included.
```

Fontsource allows you to select weights and even individual styles, allowing you to cut down on payload sizes to the last byte! Utilizing the CSS unicode-range selector, all language subsets are accounted for.

```javascript
import "fontsource-waiting-for-the-sunrise/500.css" // All styles included.
import "fontsource-waiting-for-the-sunrise/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-waiting-for-the-sunrise/cyrillic-ext-500.css" // All styles included.
import "fontsource-waiting-for-the-sunrise/greek-900-normal.css" // Select either normal or italic.
```
