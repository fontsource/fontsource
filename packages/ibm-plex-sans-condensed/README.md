...
```javascript
import "fontsource-ibm-plex-sans-condensed/500.css" // All styles included.
import "fontsource-ibm-plex-sans-condensed/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-ibm-plex-sans-condensed/cyrillic-ext-500.css" // All styles included.
import "fontsource-ibm-plex-sans-condensed/greek-900-normal.css" // Select either normal or italic.
```
