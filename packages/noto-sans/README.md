...
```javascript
import "fontsource-noto-sans/500.css" // All styles included.
import "fontsource-noto-sans/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-noto-sans/cyrillic-ext-500.css" // All styles included.
import "fontsource-noto-sans/greek-900-normal.css" // Select either normal or italic.
```
