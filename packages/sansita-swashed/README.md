...
```javascript
import "@fontsource/sansita-swashed/500.css" // Weight 500.
import "@fontsource/sansita-swashed/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/sansita-swashed/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/sansita-swashed/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/sansita-swashed/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/sansita-swashed/files/sansita-swashed-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/sansita-swashed/scss/mixins.scss).
...
```js
import "@fontsource/sansita-swashed/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/sansita-swashed/variable-italic.css" // Italic variant.
// Or
import "@fontsource/sansita-swashed/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/sansita-swashed/latin-ext.css" // All weights with normal style included.
import "@fontsource/sansita-swashed/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/sansita-swashed/greek-900-italic.css" // Italic variant.
```
