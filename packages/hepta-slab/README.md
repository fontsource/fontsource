...
```javascript
import "@fontsource/hepta-slab/500.css" // Weight 500.
import "@fontsource/hepta-slab/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/hepta-slab/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/hepta-slab/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/hepta-slab/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/hepta-slab/files/hepta-slab-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/hepta-slab/scss/mixins.scss).
...
```js
import "@fontsource/hepta-slab/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/hepta-slab/variable-italic.css" // Italic variant.
// Or
import "@fontsource/hepta-slab/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/hepta-slab/latin-ext.css" // All weights with normal style included.
import "@fontsource/hepta-slab/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/hepta-slab/greek-900-italic.css" // Italic variant.
```
