...
```javascript
import "@fontsource/rokkitt/500.css" // Weight 500.
import "@fontsource/rokkitt/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/rokkitt/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/rokkitt/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/rokkitt/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/rokkitt/files/rokkitt-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/rokkitt/scss/mixins.scss).
...
```js
import "@fontsource/rokkitt/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/rokkitt/variable-italic.css" // Italic variant.
// Or
import "@fontsource/rokkitt/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/rokkitt/latin-ext.css" // All weights with normal style included.
import "@fontsource/rokkitt/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/rokkitt/greek-900-italic.css" // Italic variant.
```
