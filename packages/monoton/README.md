...
```javascript
import "@fontsource/monoton/500.css" // Weight 500.
import "@fontsource/monoton/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/monoton/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/monoton/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/monoton/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/monoton/files/monoton-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/monoton/scss/mixins.scss).
...
```javascript
import "@fontsource/monoton/latin-ext.css" // All weights with normal style included.
import "@fontsource/monoton/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/monoton/greek-900-italic.css" // Italic variant.
```
