...
```javascript
import "@fontsource/nanum-myeongjo/500.css" // Weight 500.
import "@fontsource/nanum-myeongjo/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/nanum-myeongjo/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/nanum-myeongjo/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/nanum-myeongjo/files"
);
...
@include fontFaceCustom(
  ...
  $display: optional,
  $woff2Path:
    "~@fontsource/nanum-myeongjo/files/nanum-myeongjo-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/nanum-myeongjo/scss/mixins.scss).
...
```javascript
import "@fontsource/nanum-myeongjo/latin-ext.css" // All weights with normal style included.
import "@fontsource/nanum-myeongjo/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/nanum-myeongjo/greek-900-italic.css" // Italic variant.
```
