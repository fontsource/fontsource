...
```scss
@use "@fontsource/blackout-sunrise/scss/mixins" as BlackoutSunrise;

// Fully customisable single @font-face mixin.
@include BlackoutSunrise.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/blackout-sunrise/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/blackout-sunrise/scss/mixins.scss).
...
import "@fontsource/blackout-sunrise/greek-900-italic.css" // Italic variant.
```
