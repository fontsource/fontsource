...
```javascript
import "@fontsource/mukta/500.css" // Weight 500.
import "@fontsource/mukta/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/mukta/index.css"; // Weight 400.
...
```scss
@use "@fontsource/mukta/scss/mixins" as Mukta;

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include Mukta.fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/mukta/files"
);

// Fully customisable single @font-face mixin.
@include Mukta.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/mukta/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/mukta/scss/mixins.scss).
...
```javascript
import "@fontsource/mukta/latin-ext.css" // All weights with normal style included.
import "@fontsource/mukta/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/mukta/greek-900-italic.css" // Italic variant.
```
