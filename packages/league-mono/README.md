...
```scss
@use "@fontsource/league-mono/scss/mixins" as LeagueMono;

// Fully customisable single @font-face mixin.
@include LeagueMono.fontFaceCustom(
  $weight: 600,
  $display: optional,
...
```scss
@import "~@fontsource/league-mono/scss/mixins";
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/league-mono/scss/mixins.scss).
...
import "@fontsource/league-mono/greek-900-italic.css" // Italic variant.
```
