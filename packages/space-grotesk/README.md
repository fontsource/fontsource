...
import "@fontsource/space-grotesk/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/space-grotesk/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/space-grotesk/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/space-grotesk/files"
);
...
You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/space-grotesk/scss/mixins.scss).
...
```js
import "@fontsource/space-grotesk/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/space-grotesk/variable-italic.css" // Italic variant.
// Or
import "@fontsource/space-grotesk/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/space-grotesk/latin-ext.css" // All weights with normal style included.
import "@fontsource/space-grotesk/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/space-grotesk/greek-900-italic.css" // Italic variant.
```
