...
```javascript
import "fontsource-noto-serif-tc" // Defaults to weight 400 with all styles included.
```

Fontsource allows you to select weights and even individual styles, allowing you to cut down on payload sizes to the last byte! Utilizing the CSS unicode-range selector, all language subsets are accounted for.

```javascript
import "fontsource-noto-serif-tc/500.css" // All styles included.
import "fontsource-noto-serif-tc/900-normal.css" // Select either normal or italic.
```
...
import "fontsource-noto-serif-tc/cyrillic-ext-500.css" // All styles included.
import "fontsource-noto-serif-tc/greek-900-normal.css" // Select either normal or italic.
```
