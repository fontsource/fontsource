...
```javascript
import "@fontsource/red-rose/500.css" // Weight 500.
import "@fontsource/red-rose/900-italic.css" // Italic variant.
```

Alternatively, the same solutions could be imported via SCSS!

```scss
@import "~@fontsource/red-rose/index.css"; // Weight 400.
...
```scss
@import "~@fontsource/red-rose/scss/mixins";

// Uses a unicode-range map to automatically generate multiple @font-face rules.
@include fontFace(
  $weight: 500,
  $display: fallback,
  $fontDir: "~@fontsource/red-rose/files"
);
...
@include fontFaceCustom(
  $weight: 600,
  $display: optional,
  $woff2Path: "~@fontsource/red-rose/files/red-rose-latin-500-normal.woff2",
  $unicodeRange: false
);
// More options available in link below.
```

You can see all of the existing inputtable mixin variables [here](https://github.com/fontsource/fontsource/tree/master/packages/red-rose/scss/mixins.scss).
...
```js
import "@fontsource/red-rose/variable.css" // Contains ONLY variable weights and no other axes.
import "@fontsource/red-rose/variable-italic.css" // Italic variant.
// Or
import "@fontsource/red-rose/variable-full.css" // This contains ALL variable axes. Font files are larger.
...
```javascript
import "@fontsource/red-rose/latin-ext.css" // All weights with normal style included.
import "@fontsource/red-rose/cyrillic-ext-500.css" // Weight 500 with normal style.
import "@fontsource/red-rose/greek-900-italic.css" // Italic variant.
```
